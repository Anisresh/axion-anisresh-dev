...
import { Save, Upload, Sun, Moon, Loader2, Palette, Check } from "lucide-react";
...
function SettingsPage() {
  ...
  return (
    <div className="p-6 md:p-10 max-w-3xl mx-auto">
      ...
      <section className="mt-8 bg-card-gradient border border-border/60 rounded-3xl p-6 shadow-soft">
