...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Axion6 is a calm, premium platform for messaging, focus, and AI-powered learning." },
      { name: "author", content: "Anisresh A R" },
      { property: "og:title", content: "Axion6 — Calm, premium communication & learning" },
      { property: "og:description", content: "Axion6 is a calm, premium platform for messaging, focus, and AI-powered learning." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Axion6 — Calm, premium communication & learning" },
      { name: "twitter:description", content: "Axion6 is a calm, premium platform for messaging, focus, and AI-powered learning." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/39bf4010-9a1f-4c26-97fd-9365b348a9c3/id-preview-da0a7993--0f98d2e1-ba32-4755-8b58-9eb068733f6b.lovable.app-1780834691921.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/39bf4010-9a1f-4c26-97fd-9365b348a9c3/id-preview-da0a7993--0f98d2e1-ba32-4755-8b58-9eb068733f6b.lovable.app-1780834691921.png" },
    ],
    links: [
